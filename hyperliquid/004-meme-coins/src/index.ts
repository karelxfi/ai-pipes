...
// Popular meme coins on Hyperliquid
const MEME_COINS = [
  'DOGE', 'SHIB', 'PEPE', 'WIF', 'BONK', 'FLOKI', 'BRETT', 'POPCAT',
  'MEW', 'TRUMP', 'FARTCOIN', 'AI16Z', 'GOAT', 'PNUT', 'NEIRO',
  'MOG', 'SPX', 'GIGA', 'MOODENG', 'PENGU'
]
