...
- **Source:** evm/001-aave-v3, evm/002-lido, evm/003-binance-staked-eth
- **Issue:** CLI fetches the proxy ABI (only `Upgraded`/`AdminChanged` events) for proxy contracts. This is the #1 failure mode for major DeFi protocols — almost all use proxies.
