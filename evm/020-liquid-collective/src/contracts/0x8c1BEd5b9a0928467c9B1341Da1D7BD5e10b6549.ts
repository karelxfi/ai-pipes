...
export const events = {
    ...
    Paused: event("0x62e78cea01bee320cd4e420270b5ea74000d11b0c9f74754ebdbfc544b05a258", "Paused(address)", {"admin": p.address}),
    Unpaused: event("0x5db9ee0a495bf2e6ff9c91a7834c1ba4fdd244a5e8aa4e537bd38aeae4b073aa", "Unpaused(address)", {"admin": p.address}),
...
export const functions = {
    ...
    paused: fun("0x5c975abb", "paused()", {}, p.bool),
